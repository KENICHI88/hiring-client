              ...
              <TableBody>
                {dataList.map((row, index) => (
                  <StyledTableRow key={row._id}>
                    ...
                    <StyledTableCell component="th" scope="row">{row.route}</StyledTableCell>
                    <StyledTableCell component="th" scope="row">{row.status ? <CheckCircleIcon className={classes.active} /> : <BlockIcon className={classes.inactive} /> }</StyledTableCell>
...
PermissionListComponent.propTypes = {
